...
if (shell.exec(`npx cross-env NODE_ENV=production npx terser ${PACKAGE}.umd.js -c -m -o ${PACKAGE}.umd.min.js --source-map "includeSources=true,content='${PACKAGE}.umd.js.map',filename='${PACKAGE}.umd.min.js.map'"`).code !== 0) {
